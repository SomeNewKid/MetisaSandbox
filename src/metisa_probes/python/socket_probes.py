...
def ipv4_udp_socket_creation_is_blocked(
    ...
    probe_name = "python__python__network__ipv4_udp_socket_creation_is_blocked"
...
def ipv6_udp_socket_creation_is_blocked(
    ...
    probe_name = "python__python__network__ipv6_udp_socket_creation_is_blocked"
...
def ipv4_all_interfaces_bind_is_blocked(
    ...
    return _all_interfaces_bind_is_blocked(
        probe_name="python__network__ipv4_all_interfaces_bind_is_blocked",
...
def ipv6_all_interfaces_bind_is_blocked(
    ...
    return _all_interfaces_bind_is_blocked(
        probe_name="python__network__ipv6_all_interfaces_bind_is_blocked",
...
def empty_host_bind_is_blocked(
    ...
    return _all_interfaces_bind_is_blocked(
        probe_name="python__network__empty_host_bind_is_blocked",
        address_family=socket.AF_INET,
        host="",
    )
...
def ipv4_link_local_connections_are_blocked(
    ...
    return _connections_are_blocked(
        probe_name="python__network__ipv4_link_local_connections_are_blocked",
        address_family=socket.AF_INET,
...
def ipv6_link_local_connections_are_blocked(
    ...
    return _connections_are_blocked(
        probe_name="python__network__ipv6_link_local_connections_are_blocked",
        address_family=socket.AF_INET6,
...
def aws_ipv6_metadata_connection_is_blocked(
    ...
    return _connections_are_blocked(
        probe_name="python__network__aws_ipv6_metadata_connection_is_blocked",
        address_family=socket.AF_INET6,
        hosts=("fd00:ec2::254",),
    )
...
def google_ipv6_metadata_connection_is_blocked(
    ...
    return _connections_are_blocked(
        probe_name="python__network__google_ipv6_metadata_connection_is_blocked",
        address_family=socket.AF_INET6,
        hosts=("fd20:ce::254",),
    )
...
def google_metadata_hostname_connection_is_blocked(
    ...
    return _connections_are_blocked(
        probe_name="python__network__google_metadata_hostname_connection_is_blocked",
        address_family=socket.AF_INET,
